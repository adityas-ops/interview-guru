...
const SkillsSelection = () => {
  ...
  const selectedField = useSelector((state: RootState) => state.domain.currentDomain?.field);
  ...
  const skillsData = {
    ...
    qa: {
      skills: [
        ...
        { id: 'performance', name: 'Performance Testing', category: 'Testing Type' },
  ...
  const currentSkillsData = skillsData[selectedField as keyof typeof skillsData] || skillsData.frontend;
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.skillsGrid}>
            {currentSkillsData.skills.map((skill) => (
              ...
              >
                <Text style={[
                  styles.skillText,
                  selectedSkills.includes(skill.id) && styles.skillTextSelected
                ]}>
                  {skill.name}
                </Text>
              </TouchableOpacity>
          ...
          <View style={styles.skillsGrid}>
            {currentSkillsData.languages.map((language) => (
              <TouchableOpacity
                ...
                style={[
                  styles.skillChip,
                  selectedLanguages.includes(language) && styles.skillChipSelected
                ]}
              ...
              >
                <Text style={[
                  styles.skillText,
                  selectedLanguages.includes(language) && styles.skillTextSelected
                ]}>
                  {language}
                </Text>
              </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[
            ...
            (selectedSkills.length === 0 || selectedLanguages.length === 0) && styles.continueButtonDisabled
          ]}
          onPress={handleContinue}
          disabled={selectedSkills.length === 0 || selectedLanguages.length === 0}
        >
